...
(window as any).electronApi = {
	...
	setAllIrcChannels: (channels: any) => ipcRenderer.invoke(IPC_CHANNELS.SET_ALL_IRC_CHANNELS, channels),
	setIrcChannel: (channelName: string, channel: any) => ipcRenderer.invoke(IPC_CHANNELS.SET_IRC_CHANNEL, channelName, channel),
