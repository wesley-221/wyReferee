...
export class ManagementRouterComponent implements OnInit {
	sidebarMenu: SidebarItem[] = [
		...
		new SidebarItem({ name: 'All tournaments', htmlElementId: 'tutorial-side-bar-all-tournaments', logo: 'cloud_upload', link: '/tournament-management/tournament-overview/tournament-all-published', subMenuItem: true }),
