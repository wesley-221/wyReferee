...
export class ManagementRouterComponent implements OnInit {
	sidebarMenu: SidebarItem[] = [
		...
		new SidebarItem({ name: 'All published tournaments', logo: 'cloud_upload', link: '/tournament-management/tournament-overview/tournament-all-published', subMenuItem: true })
	];
